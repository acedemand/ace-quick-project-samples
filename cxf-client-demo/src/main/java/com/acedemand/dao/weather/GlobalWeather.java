 ...
 * 2015-05-07T10:34:57.924+03:00
 * Generated source version: 3.1.0
 * 
 */
@WebServiceClient(name = "GlobalWeather", 
                  wsdlLocation = "classpath:wsdl/globalweather.wsdl",
...
public class GlobalWeather extends Service {
    ...
    static {
        URL url = GlobalWeather.class.getClassLoader().getResource("wsdl/globalweather.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(GlobalWeather.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:wsdl/globalweather.wsdl");
        }       
        WSDL_LOCATION = url;   
    }
